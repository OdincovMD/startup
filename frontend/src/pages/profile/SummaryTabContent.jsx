/**
 * Контент таба «Обзор»: выбор роли, ORCID, OpenAlex, управление аккаунтом, привязки.
 * Рендерится в profile-page__content при profileSection === "summary".
 */
  ...
  if (loading) {
    return (
      <div className="profile-summary-card">
        <div className="profile-skeleton" style={{ height: 120, width: "100%", marginBottom: 16 }} />
        <div className="profile-skeleton" style={{ height: 200, width: "100%" }} />
      </div>
    );
  }
